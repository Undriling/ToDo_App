  ...
  return (
    ...
    <div className='flex justify-between items-center px-4 shadow-sm overflow-x-hidden'>
        <div className='flex items-center gap-2'>
            <img src="/vite.svg" alt="logo" className='h-10 w-10 md:w-15 md:h-15 size-10 cursor-pointer' onClick={() => (window.location.href = '/')}/>
            <h1 className='text-xs md:text-xl font-bold font-serif text-[#8046FD]'>ToDo</h1>
        </div>
