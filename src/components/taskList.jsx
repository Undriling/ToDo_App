...
const TaskList = () => {
  ...
  return (
    <div className="p-4 bg-gray-600 text-white rounded-lg shadow-md mt-4 w-[300px] md:w-[500px]">
      ...
      {tasks.length === 0 ? (
        <p className="text-gray-300 text-center bg-gray-800 p-3 rounded-lg">No tasks added yet.</p>
      ) : (
        <div>
            ...
            {tasks.map((task) => (
              <div key={task.id} className="p-3 bg-gray-800 rounded">
                ...
                <div className="justify-between">
                  ...
                  <p className="my-3 break-words whitespace-normal">Task:- {task.text}</p>
                </div>

                <div className="flex justify-between items-center mt-5">
                  {task.taskType === "Outdoor" ? (
                    <div className="font-sans px-2 mx-3 h-8 bg-gray-500 text-white p-1 rounded-lg text-sm">
