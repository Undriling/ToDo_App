      ...
      <div className="bg-gray-50 min-h-screen ">
        <div className="max-w-6xl mx-auto px-6 py-12 font-serif">
          ...
          <p className="mt-4 text-gray-600 text-center text-lg max-w-3xl mx-auto">
            Your ultimate Task Planner with Weather recomendation and priority task management
          </p>
          ...
          <div className="mt-12 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="mt-4 text-gray-600 text-lg text-justify leading-relaxed">
                ToDo App is your Task Planner with Weather recomendation and priority task management.
                Which is built for Simplify Task Planning & Maximize Activity .   
              ...
              <div className="mt-6 space-y-4 text-justify leading-relaxed">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-700 text-lg">Priority task management</p>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-blue-500 text-2xl">✔</span>
                ...
                <div className="flex items-start gap-4">
                  <span className="text-blue-500 text-2xl">✔</span>
                  <p className="text-gray-700 text-lg">Safe & Secure with Google Authentication for secure login experience</p>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-blue-500 text-2xl">✔</span>
                  <p className="text-gray-700 text-lg">Hassle-free task manager</p>
                </div>
              </div>
            </div>
          </div>
